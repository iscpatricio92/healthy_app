...
const EditModule = ({ data, handleSubmit, handleFormChange }) => {
  ...
  return (
    <form>
      ...
      <div className="mb-5">
        <label htmlFor="path" className="mb-3 block text-base font-medium">
          Path of this module
        </label>
        <input
          type="text"
      ...
      {formData.deleteAt && (
        <p className="bg-warning/50 mb-5 text-black">
          If you deactivate a module it could cause error for other users
        </p>
      )}
    </form>
  );
